...
app.get('/completas.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../FRONTEND/html/completas.html'));
});

app.get('/nueva_prom.html', checkAuth, (req, res) => {
  res.sendFile(path.join(__dirname, '../FRONTEND/html/nueva_prom.html'));
});

app.get('/editar_prom.html', checkAuth, (req, res) => {
  res.sendFile(path.join(__dirname, '../FRONTEND/html/editar_prom.html'));
});

app.get('/hoteles.html',(req, res) => {
  res.sendFile(path.join(__dirname, '../FRONTEND/html/hoteles.html'));
});

app.get('/nuevo_hotel.html', checkAuth, (req, res) => {
  res.sendFile(path.join(__dirname, '../FRONTEND/html/nuevo_hotel.html'));
});

app.get('/editar_hotel.html', checkAuth, (req, res) => {
  res.sendFile(path.join(__dirname, '../FRONTEND/html/editar_hotel.html'));
});

app.get('/cotizaciones.html', (req, res) => {
  res.sendFile(path.join(__dirname, '../FRONTEND/html/cotizaciones.html'));
});
...
app.get('/recuperar_contrasena.html', checkAuth, (req, res) => {
  res.sendFile(path.join(__dirname, '../FRONTEND/html/recuperar_contrasena.html'));
});
